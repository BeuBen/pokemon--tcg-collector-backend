...
import static com.beuben.pokemontcgcollectorbackend.catalog.fixture.CardSetFixture.aValidSetDTO;
...
class SetMapperTest {
  ...
  @Test
  void set_mapping_should_return_the_right_set_dto() {
    // ARRANGE
    final var model = aValidCardSet();
    final var expected = aValidSetDTO();
