...
@Qualifier("fetchAllDatabaseCardsUsecase")
public class FetchAllDatabaseCardsUsecase implements FetchAllCards {
  @Qualifier("persistenceCardAdapter") private final CardProvider provider;
